...
export default function AnalysisV2() {
  ...
  const [htfComparison, setHtfComparison] = useState<HtfFilterComparison[]>([]);
...
<section className="panel flex flex-col gap-6 p-6">
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                {[
                  ...
                  ["Context observations", analysis.contextPasses?.length ?? 0],
                  ["Live trades", analysis.live.length],
                  ["Historical trades", analysis.historical.length],
                ].map(([label, value]) => (
